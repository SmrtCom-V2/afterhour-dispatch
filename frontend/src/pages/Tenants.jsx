  ...
  return (
    <div>
      ...
      <div className="page-header">
        <h1 className="page-title">{t('tenants')}</h1>
        <p className="page-subtitle">{t('manageTenantsAcrossPM')}</p>
      </div>
      ...
      {/* PM Companies with Tenants */}
      <div className="card">
        <div className="card-header">
          <h3 className="card-title">{t('tenantsByPmCompany')}</h3>
          <span className="text-sm text-muted">
            {t('selectCompanyToManageTenants')}
          </span>
        </div>
              ...
              {pmCompanies.length === 0 ? (
                ...
                pmCompanies.map((pm) => (
                  <tr key={pm.id} className="clickable" onClick={() => navigate(`/pm/${pm.id}`)}>
                    ...
                    <td>
                      <span className="badge badge-primary">{pm.tenant_count || 0}</span>
                    </td>
